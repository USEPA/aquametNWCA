...
```{r allVasc.2}
outdf <- calcVascPlantMets(vascIn=VascPlantEx, taxaIn=taxaNWCA, taxaNat=ccNatNWCA, taxaCC=ccNatNWCA,
...
```{r subVasc.1}
sumdf <- nwcaVegData(vascIn=VascPlantEx, sampID='UID', inTaxa=taxaNWCA, inNat=ccNatNWCA, inCVal=ccNatNWCA, inWIS=wisNWCA, state = 'STATE', coeReg = 'USAC_REGION', cValReg='STATE')
str(sumdf)
```
