...
```{r allVasc.2}
outdf <- calcVascPlantMets(vascIn=VascPlantEx, taxon_name = 'USDA_NAME', 
                           taxaIn=taxaNWCA, taxaNat=ccNatNWCA, taxaCC=ccNatNWCA,
...
```{r subVasc.1}
sumdf <- nwcaVegData(vascIn=VascPlantEx, sampID='UID', taxon_name = 'USDA_NAME',
                     inTaxa=taxaNWCA, inNat=ccNatNWCA, inCVal=ccNatNWCA, inWIS=wisNWCA, 
